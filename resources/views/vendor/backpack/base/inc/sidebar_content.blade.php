...
<li class="nav-item nav-dropdown">
	...
	<ul class="nav-dropdown-items">
        ...
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('roles') }}'><i class='nav-icon la la-id-badge'></i> Roles</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('permissions') }}'><i class='nav-icon la la-list'></i> Permissions</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('rcdpwlist') }}'><i class='nav-icon la la-list'></i> Rc / Dpw Lists</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('churchentitytype') }}'><i class='nav-icon la la-church'></i> Church Entity Types</a></li>
