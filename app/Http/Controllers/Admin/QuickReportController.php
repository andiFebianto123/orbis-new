...
class QuickReportController extends Controller
{
    ...
    {
        $all_church_tables = Church::join('church_types','churches.church_type_id','church_types.id')
                        ->join('rc_dpwlists','churches.rc_dpw_id','rc_dpwlists.id')
                        ->join('country_lists','churches.country_id','country_lists.id')
                        ->select('entities_type','rc_dpw_name','country_name','church_name','founded_on','first_email',
    ...
    {
        $all_pastor_tables = Personel::join('rc_dpwlists','personels.rc_dpw_id','rc_dpwlists.id')
                        ->join('country_lists','personels.country_id','country_lists.id')
                        ->join('account_status','personels.acc_status_id','account_status.id')
